...
const migrate = async () => {
  try {
    ...
    await pool.query(`
        ...
        (12, 2, '2022-6-7', '2022-6-11'),
        (2, 8, '2022-6-8', '2022-6-14'),
        (4, 5, '2022-6-6', '2022-6-12'),
        (7, 2, '2022-6-7', '2022-6-13'),
        (1, 4, '2022-6-9', '2022-6-12'),
        (13, 3, '2022-6-6', '2022-6-13'),
        (12, 1, '2022-6-10', '2022-6-13'),
        (12, 3, '2022-6-7', '2022-6-12'),
        (7, 8, '2022-6-9', '2022-6-11'),
        (5, 9, '2022-6-9', '2022-6-14'),
        (9, 6, '2022-6-7', '2022-6-11'),
        (8, 4, '2022-6-7', '2022-6-11'),
        (13, 2, '2022-6-6', '2022-6-13'),
        (5, 10, '2022-6-10', '2022-6-11'),
        (12, 5, '2022-6-10', '2022-6-11');
    `);
